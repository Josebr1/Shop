...
<div class="page-flexbox-wrapper">
    ...
    <main>
        <div class="row">
            <div class="">
                <ul class="tabs">
                    <li class="tab col s3"><a class="active orange-text text-darken-4" href="#test1">Pedido
                            Realizado</a></li>
                    <li class="tab col s3"><a class="orange-text text-darken-4" href="#test2">Pedido Cancelado</a></li>
                    <li class="tab col s3"><a class="orange-text text-darken-4" href="#test3">Pedido saiu para
                            entrega</a></li>
                    <li class="tab col s3"><a class="orange-text text-darken-4" href="#test4">Pedido Finalizado</a></li>
                </ul>
            </div>
            ...
            <div id="test3" class="col s10 offset-m1">
                <div class="row">
                    <div class="row">
